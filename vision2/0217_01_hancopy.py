...
train_a = pd.read_csv('C:/data/dacon/mnist1/data/test.csv')
...
# 컴터 데이터 
x_data = np.load('C:/data/dacon/mnist2/copy/npy/train_data.npy')
y_data = pd.read_csv('C:/data/dacon/mnist2/dirty_mnist_2nd_answer.csv')
...
x_pred = np.load('C:/data/dacon/mnist2/copy/npy/predict_data.npy')
