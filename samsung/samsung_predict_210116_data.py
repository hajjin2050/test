...
dfadd_1 = pd.read_csv('../../data/csv/samsung_2.csv', index_col=0, header=0, encoding='cp949', thousands=',') 
dfadd_1 = dfadd_1.iloc[::-1].reset_index(drop=True)
dfadd_1_data = dfadd_1.iloc[58:, [0,1,2,3,11,12,13,14]]
added_df = pd.concat([df2, dfadd_1_data]).reset_index(drop=True)


dfadd_2 = pd.read_csv('../../data/csv/samsung_3.csv', index_col=0, header=0, encoding='cp949', thousands=',') 
dfadd_2 = dfadd_2.iloc[::-1].reset_index(drop=True)
dfadd_2_data = dfadd_2.iloc[58:, [0,1,2,3,11,12,13,14]]
df20210115 = pd.concat([added_df, dfadd_2_data]).reset_index(drop=True)



# x, y 데이터 지정
x = df20210115.iloc[1800:2400, [0,1,2,3,7,8]]
y = df20210115.iloc[1801:2402, 3]
x_pred = df20210115.iloc[2400, [0,1,2,3,7,8]]
