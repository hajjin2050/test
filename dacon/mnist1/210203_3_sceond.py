...
for train_index, valid_index in skf.split(train2, train['digit']) : # >>> x, y
    path = 'C:/data/dacon/mnist1/modelcheck/0203_1_cp.hdf5'
    ...
    #4. Evaluate, Predict
    model.load_weights('C:/data/dacon/mnist1/modelcheck/0203_1_cp.hdf5')
...
print(sub)
sub.to_csv('C:/data/dacon/mnist1/submit/210203_2_copy.csv',index=False)