...
from tensorflow.keras.layers import Conv2D, Flatten, Dense, Dropout, MaxPool2D, LSTM
...
submission.to_csv('C:/data/dacon/mnist1/submit/210202_lstm.csv',index= False)
