...
df_train = preprocess_data(train)# df_train = [52464 rows x 8 columns]
...
x_test = x_test.to_numpy() #x_test.shape(3888, 6)
print(x_test.shape)
...
print('x_train.shape:',x_train.shape) # (52464, 8)
print('x_test.shape:',x_test.shape) #(3888, 1, 6) 
# print(x.shape,y1.shape,y2.shape) (52464, 1, 6) (52464, 1) (52464, 1)
from sklearn.model_selection import train_test_split
x_train, x_val, y1_train, y1_val, y2_train, y2_val = train_test_split(x, y1, y2, train_size=0.7, shuffle = False,random_state= 0)
...
def mymodel():
    model = Sequential()
    model.add(Conv1D(256,2,padding = 'same', activation = 'relu',input_shape = (1,6)))
...
submission.to_csv('C:/data/dacon/practice/0121_2.csv', index = False)
