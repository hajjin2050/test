...
x_pred = np.load('C:/workspace/lotte/npy/x_test.npy',allow_pickle=True)
...
for train_index, valid_index in skf.split(x,y) :
    ...
    mc = ModelCheckpoint('C:/workspace/lotte/h5/lotte_try_1.h5',save_best_only=True, verbose=1)
    ...
    # predict
    model.load_weights('C:/workspace/lotte/h5/lotte_try_1.h5')
...
print(result.shape)
sub = pd.read_csv('C:/workspace/lotte/sample.csv')
sub['prediction'] = result
sub.to_csv('C:/workspace/lotte/submit/answer.csv',index=False)
