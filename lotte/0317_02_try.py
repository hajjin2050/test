...
mobule = EfficientNetB7(weights='imagenet', include_top=False, input_shape=(128,128,3))
...
file_path = 'C:/workspace/lotte/h5/lotte_swish_B7.hdf5'
...
model = load_model('C:/workspace/lotte/h5/lotte_swish_B7.hdf5')
...
submission.to_csv('C:/workspace/lotte/submit/lotte_swish_B7.csv', index=False)
