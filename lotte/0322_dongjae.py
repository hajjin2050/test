...
for i in range(1000):
    if not os.path.exists('C:/workspace/lotte/train_new2/{0:04}'.format(i)):
        os.mkdir('C:/workspace/lotte/train_new2/{0:04}'.format(i))
    for img in range(24,48):


        original = cv2.imread('C:/workspace/lotte/train_new/{0:04}/{1:02}.jpg'.format(i, img))
        ...
        cv2.imwrite('C:/workspace/lotte/train_new2/{0:04}/{1:02}.jpg'.format(i, img+24), modified)
