...
mobule = EfficientNetB4(weights='imagenet', include_top=False, input_shape=(128,128,3))
mobule.trainable = True
...
file_path = 'C:/workspace/lotte/h5/lotte_eff4.hdf5'
...
model.fit(x_train, y_train, batch_size=12, epochs=200, validation_data=(x_val, y_val),callbacks=[es,mc,rl])
from tensorflow.keras.models import load_model
from sklearn.metrics import r2_score

model = load_model('C:/workspace/lotte/h5/lotte_eff4.hdf5')
...
submission.to_csv('C:/workspace/lotte/submit/lotte_eff4.csv', index=False)