...
file_path = 'C:/workspace/lotte/h5/lotte_swish.hdf5'
...
model = load_model('C:/workspace/lotte/h5/lotte_swish.hdf5')
...
submission.to_csv('C:/workspace/lotte/submit/lotte_swish.csv', index=False)
